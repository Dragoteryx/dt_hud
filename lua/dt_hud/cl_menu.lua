...
hook.Add("PopulateToolMenu", "DT_HUD/ToolMenu", function()
  ...
  spawnmenu.AddToolMenuOption("Utilities", "dt_hud", "client", "#dt_hud.menu.client", "", "", function(panel)
    ...
    panel:NumSlider(GetText("misc.scale"), DT_HUD.Scale:GetName(), 0.5, 1.5, 1)
    panel:NumSlider(GetText("misc.blur"), DT_HUD.Blur:GetName(), 0, 3, 0)
    ...
    panel:CheckBox(GetText("status.effects"), DT_HUD.StatusEffectsEnabled:GetName())
