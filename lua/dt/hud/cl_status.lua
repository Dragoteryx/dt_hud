...
local HEALTH = nil
local ARMOR = nil
hook.Add("Think", "DT/HUD_HealthArmorLerp", function()
...
hook.Add("Think", "DT/HUD_RefreshFPSPing", function()
...
hook.Add("DT/HUD_ShouldDraw", "DT/HUD_HideStatus", function(name)
...
hook.Add("DT/HUD_Draw", "DT/HUD_DrawStatus", function()
